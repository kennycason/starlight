 ...
 */
public class EnergyRed extends Bullet {

    private AnimatedSprite sprite;

    public EnergyRed(final StarLight game, final Movement movement) {
        super(game, movement);
        sprite = new AnimatedSprite(game, Textures.Weapons.ENERGY_RED, 1, 4);
