 ...
 */
public class BulletSingle extends Bullet {

    private AnimatedSprite sprite;

    public BulletSingle(final StarLight game, final Movement movement) {
        super(game, movement);
        sprite = new AnimatedSprite(game, Textures.Weapons.BULLET1, 1, 4);
