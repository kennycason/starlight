...
import com.kennycason.starlight.movement.Sine;
 ...
 */
public class BioMechBaby extends Enemy {

    public AnimatedSprite sprite;
    private boolean isAngry = false;

    public BioMechBaby(final StarLight game) {
        super(game, new Sine(-150, 5, 5));
        life = 1;
        score = 20;
        sprite = new AnimatedSprite(game, Textures.Enemies.ENEMY0, 4);
